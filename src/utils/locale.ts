...
type NamespacedFluentMessageId = Extract<
  FluentMessageId,
  `${typeof config.addonRef}-${string}`
>;
type UnnamespacedFluentMessageId = Exclude<
  FluentMessageId,
  NamespacedFluentMessageId
>;
type RuntimeFluentMessageId =
  | UnnamespacedFluentMessageId
  | (NamespacedFluentMessageId extends `${typeof config.addonRef}-${infer Id}`
      ? Id
      : never);
 ...
 * ```
 */
function getString(localString: RuntimeFluentMessageId): string;
function getString(localString: RuntimeFluentMessageId, branch: string): string;
function getString(
  localeString: RuntimeFluentMessageId,
...
function getLocaleID(id: RuntimeFluentMessageId) {
